...
<body>
	...
	<div class="news-breadline">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					当前位置：<a href="/">首页</a><span>></span><a href="#">移民新政</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="news-search">
				<p>
					<input class="news-search-input" type="text" id="search_key"
						name="search_key" placeholder="搜索你感兴趣的新政、问题、标签" /> <input
						class="news-search-button" id="btnSearch" type="button" value="搜索" />
				</p>
					...
					<c:if test="${status.index == 0 }">
						<div class="country-new-policy container">
							...
							<div class="country-list-text">
								...
								<p class="text-right">
									<a href="/policy/detail/${item.info_id }"><span
										class="country-seemore">查看详细</span></a>
								</p>
							</div>
						</div>
					</c:if>
	...
	<script>
		...
		$("#btnSearch").click(
				function(e) {
					...
					window.open(rootUrl + "/policy/search?keys="
							+ $("#search_key").val());
				});
	</script>
