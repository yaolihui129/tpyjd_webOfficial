...
public class Node {
	...
	public String getNodeString(Node node){
		...
		if(node.subNodes.size()==0){
			...
			if(node.isSelected())
				nodeName = "<b><font color=\"#ff0000\">"+nodeName+"</font></b>";
			String title="<a data-role=\"leaf\" data-info=\""+node.getExtInfo()+"\" data-value=\""+node.getCode()+"\">"+checkboxShow+"<span class=\"split-right\"><i class=\"icon-chevron-right\"></i>"+nodeName+"</span>";
			...
			String title="<a class=\"tree-toggle "+closed+"\"  data-info=\""+node.getExtInfo()+"\" data-toggle=\"branch\" data-value=\""+node.getCode()+"\">"+checkboxShow+"<span class=\"split-right\">"+nodeName+"</span>";
			if(node.isAllownEdit())
